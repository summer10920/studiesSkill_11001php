...
// 若是想將 curl_exec() 獲取結果以文字串方式返回，而不是直接印出。
...
// 設定 URL 位置
curl_setopt($curl, CURLOPT_URL, "https://data.ntpc.gov.tw/api/datasets/71CD1490-A2DF-4198-BEF1-318479775E8A/json?page=0&size=700");
